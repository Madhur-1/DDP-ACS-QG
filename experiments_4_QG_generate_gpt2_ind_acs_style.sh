...
# st_idx=0
# ed_idx=10000
# CUDA_VISIBLE_DEVICES=0 PYTHONIOENCODING=utf-8 python3 -u QG_gpt2_generate_ind_acs_style.py  \
#     --model_type gpt2 \
#     --model_name_or_path /scratch/scratch8/madhurjindal/ACS-QG-Scratch/file/QG/gpt2_ind_acs/train_style/ \
#     --filename "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_clue.pkl" \
#     --data_type augmented_sents \
#     --output_file "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_style.txt" \
#     --top_p 0.0 \
#     --save_freq 100 \
#     --debug \
#     --debug_num 100 &> experiments_4_QG_generate_gpt2_ind_acs_style
...
#     --model_type gpt2 \
#     --model_name_or_path /scratch/scratch8/madhurjindal/ACS-QG-Scratch/file/QG/gpt2_ind_acs/train_style/ \
#     --filename "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_clue.debug.pkl" \
#     --data_type augmented_sents \
#     --output_file "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_ans.txt" \
#     --top_p 0.0 \
#     &>> experiments_4_QG_generate_gpt2_ind_acs_style
...
#     --save_freq 100 \
#     --debug \
#     --debug_num 500 &>> experiments_4_QG_generate_gpt2_ind_acs_style
...
# CUDA_VISIBLE_DEVICES=0 PYTHONIOENCODING=utf-8 python3 -u QG_gpt2_generate_ind_acs_style.py  \
#     --model_type gpt2 \
#     --model_name_or_path /scratch/scratch8/madhurjindal/ACS-QG-Scratch/file/QG/gpt2_ind_acs__full_para/train_style/ \
#     --filename "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_clue.pkl" \
#     --data_type augmented_sents \
#     --output_file "$output_path${data_file_prefix}.${st_idx}_${ed_idx}.generated.gpt2.ind_style.txt" \
#     --top_p 0.0 \
