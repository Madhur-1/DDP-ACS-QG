...
def train(gpu, args):
    ...
    if args.distributed:
        ...
        torch.distributed.init_process_group(backend="nccl", init_method="env://", world_size=args.num_gpus, rank=gpu)
    ...
    if args.local_rank in [-1, 0]:
        ...
        checkpoint_handler = ModelCheckpoint(
            args.output_dir, "checkpoint", save_interval=1, n_saved=3, require_empty=False
