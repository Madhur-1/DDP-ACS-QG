...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    # print("exact_raw={}".format(exact_raw))
    # print("f1_raw={}".format(f1_raw))
    ...
    fout.close()
    return results, exact_raw, f1_raw
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            # Evaluate
            result, exact_raw, f1_raw = evaluate(args, model, tokenizer, prefix=global_step)
