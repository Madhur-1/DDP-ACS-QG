...
original_data_folder = os.path.join(os.path.join(DATA_PATH, "original"), dataset_name) + "/"
processed_data_folder = os.path.join(os.path.join(DATA_PATH, "processed"), dataset_name) + "/"
...
parser.add_argument("--log_file", default="log.txt", type=str, help="path of log file")
parser.add_argument(
    "--no_cuda", default=False, action="store_true", help="not use cuda"
)
parser.add_argument(
    "--use_multi_gpu",
    default=False,
...
parser.add_argument(
    "--debug", default=False, action="store_true", help="debug mode or not"
)
parser.add_argument(
    "--debug_batchnum",
    default=5,
...
parser.add_argument(
    ...
    type=str,
    help="path of train dataset examples file",
)
parser.add_argument(
    "--dev_examples_file",
    default=processed_data_folder + "dev-examples.pkl",
    type=str,
    help="path of dev dataset examples file",
)
parser.add_argument(
    "--test_examples_file",
    default=processed_data_folder + "test-examples.pkl",
    type=str,
    help="path of test dataset examples file",
)
...
parser.add_argument(
    ...
    type=str,
    help="path of train dataset meta file",
)
parser.add_argument(
    "--dev_meta_file",
    default=processed_data_folder + "dev-meta.pkl",
    type=str,
    help="path of dev dataset meta file",
)
parser.add_argument(
    "--test_meta_file",
    default=processed_data_folder + "test-meta.pkl",
    type=str,
    help="path of test dataset meta file",
)
...
parser.add_argument(
    ...
    type=str,
    help="path of train dataset eval file",
)
parser.add_argument(
    "--dev_eval_file",
    default=processed_data_folder + "dev-eval.pkl",
    type=str,
    help="path of dev dataset eval file",
)
parser.add_argument(
    "--test_eval_file",
    default=processed_data_folder + "test-eval.pkl",
    type=str,
    help="path of test dataset eval file",
)
...
parser.add_argument(
    ...
    type=str,
    help="path of train result file",
)
parser.add_argument(
    "--eval_output_file",
    default=processed_data_folder + "eval_output.txt",
    type=str,
    help="path of evaluation result file",
)
parser.add_argument(
    "--test_output_file",
    default=processed_data_folder + "test_output.txt",
    type=str,
    help="path of test result file",
)
...
parser.add_argument(
    ...
    type=str,
    help="path of embedding matrices file",
)
parser.add_argument(
    "--emb_dicts_file",
    default=processed_data_folder + "emb_dicts.pkl",
    type=str,
    help="path of embedding dicts file",
)
parser.add_argument(
    "--counters_file",
    default=processed_data_folder + "counters.pkl",
    type=str,
    help="path of counters file",
)
...
parser.add_argument(
    "-e", "--epochs", default=10, type=int, help="number of total epochs (default: 20)"
)
parser.add_argument(
    "--val_num_examples",
    default=10000,
...
parser.add_argument(
    "--checkpoint_dir",
    default=OUTPUT_PATH + "checkpoint/",
    type=str,
...
parser.add_argument(
    "--ema_decay", default=0.9999, type=float, help="exponential moving average decay"
)
parser.add_argument(
    "--use_early_stop",
    default=True,
...
parser.add_argument(
    "--early_stop", default=20, type=int, help="checkpoints for early stop"
)
...
parser.add_argument(
    "-eval_per_batch", type=int, default=500, help="""evaluate on dev per x batches."""
)
parser.add_argument(
    "-halve_lr_bad_count", type=int, default=1, help="""for change lr."""
)

# model
parser.add_argument(
    "--para_limit", default=400, type=int, help="maximum context token number"
)
parser.add_argument(
    "--ques_limit", default=50, type=int, help="maximum question token number"
)
parser.add_argument(
    "--ans_limit", default=30, type=int, help="maximum answer token number"
)
parser.add_argument(
    "--sent_limit", default=100, type=int, help="maximum sentence token number"
)
parser.add_argument(
    "--char_limit", default=16, type=int, help="maximum char number in a word"
)
parser.add_argument(
    "--bpe_limit", default=6, type=int, help="maximum bpe number in a word"
)
parser.add_argument(
    "--emb_config", default=emb_config, type=dict, help="config of embeddings"
)
parser.add_argument(
    "--emb_tags",
    default=emb_tags,
...
parser.add_argument("--d_model", default=128, type=int, help="model hidden size")
parser.add_argument("--num_head", default=8, type=int, help="num head")
parser.add_argument("-beam_size", type=int, default=5, help="Beam size")
parser.add_argument(
    "-layers", type=int, default=1, help="Number of layers in the LSTM encoder/decoder"
)
parser.add_argument(
    "-enc_rnn_size", type=int, default=512, help="Size of LSTM hidden states"
)
parser.add_argument(
    "-dec_rnn_size", type=int, default=512, help="Size of LSTM hidden states"
)
parser.add_argument(
    "-att_vec_size", type=int, default=512, help="Concat attention vector sizes"
)
parser.add_argument(
    "-maxout_pool_size", type=int, default=2, help="Pooling size for MaxOut layer."
)
parser.add_argument(
    "-input_feed",
    type=int,
...
parser.add_argument(
    "--copy_loss_type", default=1, type=int, help="the type of copy loss function"
)
parser.add_argument(
    "--only_copy_content",
    default=False,
...
parser.add_argument("--clue_coef", default=1.0, type=float, help="clue loss coef")
parser.add_argument("--style_coef", default=1.0, type=float, help="style loss coef")
parser.add_argument(
    "--data_type", default="squad", type=str, help="which dataset to use"
)
parser.add_argument(
    "--net", default="FQG", type=str, help="which neural network model to use"
)
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="do experiment for complete model",
)
parser.add_argument(
    "--ablation_no_clue",
    default=False,
    action="store_true",
    help="remove clue information",
)
parser.add_argument(
    "--ablation_no_answer",
    default=False,
    action="store_true",
    help="remove answer information",
)
parser.add_argument(
    "--ablation_no_style",
    default=False,
    action="store_true",
    help="remove style information",
)
parser.add_argument(
    "--ablation_no_cfseparate",
    default=False,
    action="store_true",
    help="remove content function separation information",
)
parser.add_argument(
    "--ablation_no_softcopy",
    default=False,
    action="store_true",
    help="remove soft copy mechanism",
)
...
parser.add_argument("--da_input_file", default="", type=str, help="path to input file")
parser.add_argument(
    "--da_input_type",
    default="",
    type=str,
...
parser.add_argument(
    "--da_sentences_file", default="", type=str, help="path to output file"
)
parser.add_argument(
    "--da_paragraphs_file", default="", type=str, help="path to output file"
)
parser.add_argument(
    "--da_augmented_sentences_file", default="", type=str, help="path to output file"
)
parser.add_argument(
    "--da_task",
    default="",
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="whether processed sample probs file",
)
