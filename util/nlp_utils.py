...
def load_w2v(fin, binary, vector_size, specials=["<oov>", "<pad>", "<sos>", "<eos>"]):
    """
    ...
    model = gensim.models.KeyedVectors.load_word2vec_format(fin, binary=binary)
...
def read_w2v(
    ...
    if os.path.isfile(cache_file):
        ...
        wv_tensor, wv_word2ix, wv_vocab, wv_dim = pickle_load_large_file(cache_file)
        ...
        pickle_dump_large_file([wv_tensor, wv_word2ix, wv_vocab, wv_dim], cache_file)
