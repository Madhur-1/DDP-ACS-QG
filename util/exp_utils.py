...
def get_checkpoint_dir(save_dir, args_for_checkpoint_folder_name):
    checkpoint_folder = [str(s) for s in args_for_checkpoint_folder_name]
    checkpoint_folder = "_".join(checkpoint_folder)
    checkpoint_folder = save_dir + checkpoint_folder + "/"
