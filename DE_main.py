...
if EXP_PLATFORM.lower() == "venus":
    ...
    model = GPT2LMHeadModel.from_pretrained('/scratch/scratch8/madhurjindal/ACS-QG-Scratch/models/gpt2')
model.eval()
...
if EXP_PLATFORM.lower() == "venus":
    ...
    tokenizer = GPT2Tokenizer.from_pretrained('/scratch/scratch8/madhurjindal/ACS-QG-Scratch/models/gpt2')
...
if __name__ == "__main__":
    ...
    start = timer()
    print([get_readibility(i) for i in a])
    end = timer()
    print(end - start)
