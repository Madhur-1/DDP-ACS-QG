...
def select_clues(
    context, answer, answer_bio_ids, max_dependency_distance, processed_by_spacy=False
):
    """
    ...
    for aid in range(answer_start, answer_end + 1):
        ...
        for tk_id, path in sort_related:
            if (tk_id < answer_start or tk_id > answer_end) and len(
                path
...
if __name__ == "__main__":
    ...
    print(
        clues
    )  # [('Mary has lived', [1, 1, 1, 0, 0, 0, 0, 0]), ('ten years', [0, 0, 0, 0, 0, 0, 1, 1])]
