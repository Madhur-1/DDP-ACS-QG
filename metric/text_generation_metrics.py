...
sys.path.append(
    r"E:\WorkProjects\DDP\PaperImplemetations\ACS-QG\metric\nlgeval\pycocoevalcap\meteor"
)
...
if __name__ == "__main__":
    gold = [["Which game console\nhehe could".split()], ["Which game c2222 ?".split()]]
    predict = ["Who does the CBS Sports apps".split(), "Which game c2222 ?".split()]
    ...
    print(
        "result by compute_metrics_by_list: ",
        compute_metrics_by_list(gold, predict, f_gold="gold.txt", f_pred="pred.txt"),
    )
